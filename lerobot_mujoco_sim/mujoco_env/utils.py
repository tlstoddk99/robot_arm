    ...
    for p_idx in range(n_sample):
        ...
        while True:
            ...
            if attempt > max_attempts:
                raise ValueError(
                    "sample_xyzs failed to place points within max_attempts. "
                    f"n_sample={n_sample}, p_idx={p_idx}, x_range={x_range}, "
                    f"y_range={y_range}, z_range={z_range}, min_dist={min_dist}, "
                    f"xy_margin={xy_margin}, max_attempts={max_attempts}"
                )
